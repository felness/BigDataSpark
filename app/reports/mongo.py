...
def reports_mongodb(spark, config):
    """
    ...
    write_mongodb(sales_by_product, config, "sales_by_product")
    ...
    write_mongodb(sales_by_customer, config, "sales_by_customer")
    ...
    write_mongodb(sales_by_time, config, "sales_by_time")
    ...
    write_mongodb(sales_by_store, config, "sales_by_store")
    ...
    write_mongodb(sales_by_supplier, config, "sales_by_supplier")
    ...
    write_mongodb(product_quality, config, "product_quality")

    logger.info("Все витрины успешно созданы в MongoDB")
...
def write_mongodb(df, config, collection):
    """
    ...
    df.write \
        ...
        .option("database", config["datasource"]["mongodb"]["database"]) \
